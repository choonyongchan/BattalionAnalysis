...
--> statement-breakpoint
CREATE TABLE "report_sick_formsg" (
	...
	"mc_days" smallint,
	"status_1" text,
	"status_1_days" smallint,
	"status_2" text,
	"status_2_days" smallint,
	"status_3" text,
	"status_3_days" smallint,
	"status_4" text,
	"status_4_days" smallint,
	"status_5" text,
	"status_5_days" smallint,
	"company" "company",
	"report_sick_date" date NOT NULL,
	"received_at" timestamp with time zone DEFAULT now() NOT NULL,
	"symptom_category" text,
	"symptom_other_text" text,
	CONSTRAINT "report_sick_formsg_mc_days_sane" CHECK ("report_sick_formsg"."mc_days" is null or "report_sick_formsg"."mc_days" between 0 and 180)
);
--> statement-breakpoint
